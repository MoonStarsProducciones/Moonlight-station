...
game-ticker-get-info-text = Olá e bem-vindo a [color=white]Moonlight Station![/color]
...
game-ticker-get-info-preround-text = Olá e bem-vindo a [color=white]Moonlight Station![/color]
                            A rodada atual é: [color=white]#{$roundId}[/color]
